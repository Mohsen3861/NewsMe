...
public class ArticleAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (currentItem.getUserId() != null && user !=null) {

            String[] users = currentItem.getUserId().split(",");

            //favorit button
            if (!user.getId().isEmpty() && Arrays.asList(users).contains(user.getId()))
        ...
        holder.favoritButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!currentArticle.isSaved()) {
                    ...
                    if (user != null) {
                        currentArticle.setUserId(currentArticle.getUserId()+","+user.getId());
                    ...
                    if (user != null) {
                        List<String> usersList =Arrays.asList(currentArticle.getUserId().split(","));
                        ArrayList<String> usersArray = new ArrayList<String>(usersList);
                        usersArray.remove(user.getId());



                        currentArticle.setUserId(TextUtils.join(",", usersArray));
